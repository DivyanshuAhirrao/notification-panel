...
const NotifyBell = () => {
  ...
  //   if(userData.firstName === users[item].firstName){
  //     setLiker(users[item].like)
  //   }
  // }
          ...
          >
            ...
            <div className="text-gray-700 font-mono text-[16px] relative top-3 pl-2">
              <div className="flex w-[370px]">
                <p className="w-[25%]">Name : </p> {userData.firstName}
                {userData.lastName}
              </div>
              <div className="flex w-[370px]">
            ...
            <section className="w-[94%] h-[435px] rounded-lg bg-[#ffff001e] relative top-6">
              ...
              <section className="h-[100%] overflow-y-scroll">
                <BasicTabs />
              </section>
            </section>
          </div>
