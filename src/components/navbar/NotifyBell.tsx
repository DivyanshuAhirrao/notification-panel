...
const NotifyBell = () => {
  ...
  return (
    <div>
      ...
      {flag ? (
        <>
          <div id="notify-box" className="flex flex-col items-center h-[90vh] w-[300px] absolute right-0 top-[73px] transition-all duration-500 border-l-2 border-t-2 border-emerald-900">
